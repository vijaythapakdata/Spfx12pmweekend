...
import { INasaItemResponse } from '../../models/INasaImageResponse';
...
export default class GraphApiKeyWebPart extends BaseClientSideWebPart<IGraphApiKeyWebPartProps> {
  ...
  public async render(): Promise<void> {
    if(!this.renderedOnce){
      const response:INasaItemResponse=await this._getAppolloMissionImages();
  ...
  //get images
  private async _getAppolloMissionImages():Promise<INasaItemResponse>{
